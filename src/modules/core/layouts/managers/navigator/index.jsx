...
export const Navigator = (props) => {
  ...
  const firstBtnProps = {
    ...
    onClick: () => {
      ctxValueOption.dispatch({ type: "SET_INDEX_FIRST" });
    },
    disabled: index === 0,
  };
  ...
  const prevBtnProps = {
    ...
    onClick: () => {
      ctxValueOption.dispatch({ type: "SET_INDEX_PREVIOUS" });
    },
  ...
  const nextBtnProps = {
    ...
    onClick: () => {
      ctxValueOption.dispatch({ type: "SET_INDEX_NEXT" });
    },
  ...
  const lastBtnProps = {
    ...
    onClick: () => {
      ctxValueOption.dispatch({ type: "SET_INDEX_LAST" });
    },
